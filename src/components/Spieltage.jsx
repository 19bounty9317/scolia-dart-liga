...
function Spieltage({ user }) {
  ...
  const handleSubmitResult = async () => {
    ...
    // Best of 10: Gewinner braucht 6 Legs, Verlierer kann 0-5 haben
    ...
    if (!isValidResult || legs1 < 0 || legs2 < 0 || legs1 > 6 || legs2 > 6) {
      alert('Ungültiges Ergebnis! Bei Best of 10 gewinnt wer zuerst 6 Legs hat (z.B. 6:0, 6:1, 6:3, 6:5) oder es endet 5:5 unentschieden.')
      return
    }
        ...
        <div style={{
          ...
          <div className="card" style={{ maxWidth: '400px', width: '90%' }}>
            ...
            <p style={{ fontSize: '14px', color: 'var(--text-secondary)', marginBottom: '15px' }}>
              Best of 10 Legs (First to 6 gewinnt - Spiel endet bei 6 Legs, z.B. 6:0, 6:1, 6:3 oder 5:5 unentschieden)<br/>
